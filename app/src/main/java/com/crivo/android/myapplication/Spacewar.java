...
public class Spacewar extends AppCompatActivity implements View.OnTouchListener {
                ...
                while (!isInterrupted()) {
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            switch (btn) {
                                case 1:
                                    Spaceship.coordinate_x += Spaceship.shipVelocity;
                                    Spaceship.shipDirection = Spaceship.Direction.EAST;
                                    break;
                                case 2:
                                    Spaceship.coordinate_x -= Spaceship.shipVelocity;
                                    Spaceship.shipDirection = Spaceship.Direction.WEST;
                                    break;
                                case 3:
                                    Spaceship.coordinate_y -= Spaceship.shipVelocity;
                                    Spaceship.shipDirection = Spaceship.Direction.NORTH;
                                    break;
                                case 4:
                                    Spaceship.coordinate_y += Spaceship.shipVelocity;
                                    Spaceship.shipDirection = Spaceship.Direction.SOUTH;
                                    break;
                            }
                        }
                    });
    ...
    protected void onPause() {
        ...
        super.onPause();
        if (misPlaying){
            musicService.pauseMusic(); misPlaying=false;}
    }
    ...
    protected void onResume() {
        ...
        startService(music);
        if (!misPlaying){
            musicService.resumeMusic(); misPlaying=true;}
    }
